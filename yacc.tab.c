...
{
       0,    24,    24,    30,    38,    47,    53,    57,    60,    65,
      71,    78,    86,    92,    93,    94,    98,   101
};
#endif
...
static const char *const yytname[] =
{
  ...
  "WHILE", "DO", "RELOP", "NUMBER", "ID", "AND", "'+'", "'-'", "'*'",
  "'/'", "'='", "ASSIGN", "';'", "$accept", "S", "L", "E", "OP", "M", "N", YY_NULLPTR
};
...
{
      21,    24,   -12,   -12,   -12,    10,     1,    -9,    12,    -6,
      24,   -12,   -12,    24,    24,   -12,   -12,    24,    25,    21,
     -12,    15,    21,    24,    16,   -12,   -12,    31,   -12,    21,
     -12,   -12,   -12,    21,   -12
};
...
{
       7,     0,    16,    14,    15,     9,     6,     0,     0,    12,
       0,     1,    16,     0,     0,    16,    16,     0,     0,     7,
      13,     5,     7,     0,    11,    16,     8,     2,    10,     7,
      17,     4,    16,     7,     3
};
...
{
       9,    19,    17,    13,    22,    23,    13,    18,    14,     9,
      11,    21,    20,     9,    29,    26,    24,    15,    27,    12,
      28,    33,     9,    16,     1,    31,    16,     2,    13,    34,
       3,     4,    25,     3,     4,    30,    16
};

static const yytype_int8 yycheck[] =
{
       1,    12,     8,    12,    15,    16,    12,    10,    17,    10,
       0,    14,    13,    14,    25,    19,    17,     5,    22,    18,
      23,    32,    23,    11,     3,    29,    11,     6,    12,    33,
       9,    10,     7,     9,    10,     4,    11
};
...
{
       0,     3,     6,     9,    10,    20,    21,    23,    22,    23,
      24,     0,    18,    12,    17,     5,    11,     8,    22,    24,
      23,    22,    24,    24,    23,     7,    20,    20,    22,    24,
       4,    20,    25,    24,    20
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* S: IF E THEN M S  */
#line 25 "yacc.y"
                { 	
			backpatch(list, yyvsp[-2].truelist, yyval.instr); 
			yyval.nextlist = merge(yyvsp[-3].falselist, yyvsp[0].nextlist); 
		}
#line 1103 "yacc.tab.c"
    break;

  case 3: /* S: IF E THEN M S ELSE N M S  */
#line 31 "yacc.y"
                { 	
...
#line 1142 "yacc.tab.c"
    break;

  case 7: /* S: %empty  */
#line 57 "yacc.y"
                        {}
#line 1148 "yacc.tab.c"
    break;
...
#line 1175 "yacc.tab.c"
    break;

  case 11: /* E: OP RELOP OP  */
#line 79 "yacc.y"
                {	
...
#line 1194 "yacc.tab.c"
  ...
  case 13: /* OP: OP '+' OP  */
#line 92 "yacc.y"
                          { new_temp(&yyval, get_temp_index(list)); gen_3addr(list, yyval, yyvsp[-2], "+", yyvsp[0]); }
